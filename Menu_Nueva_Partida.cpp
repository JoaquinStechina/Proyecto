...
Menu_Nueva_Partida::Menu_Nueva_Partida() : fondo("Imagenes/Fondos/fondo2_1.png"), opc1("Creador de Personaje",50), Menu("Imagenes/Sprites/Letrero_metal.png") {
	opc1.Cambiar_Escala_Opcion_Menu(2);
	opc1.Cambiar_Pos_Cuadro_Menu(600,100);
	opc1.Cambiar_Pos_Opcion_Menu(600,90);
	Menu.cambiar_escala_bloque(1.5,6.0);
